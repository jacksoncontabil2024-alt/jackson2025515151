...
- Deck de 20 slides conforme estrutura aprovada (capa → conclusão), navegação por teclado/clique/hash, barra de progresso, dock de controles, visão geral em grade (tecla O)
...
- Logo Felcont recriado em SVG (o print enviado não chegou como anexo recuperável — trocar pelo vetor oficial se disponível)
...
## Backlog priorizado
- P0: substituir logo SVG pelo vetor oficial Felcont quando enviado
