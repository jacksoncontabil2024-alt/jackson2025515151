...
Exemplo prático: comece perguntando à plateia quem já explicou um EBITDA para cliente — esse é exatamente o tipo de número que a norma passa a disciplinar.`,
  // 2 — Perguntas-chave
  `Use este slide como o contrato da reunião: quatro perguntas que todo cliente e toda equipe fazem. O que é → norma de APRESENTAÇÃO, não de mensuração: o lucro não muda. O que muda → a forma de classificar, apresentar e divulgar. Quando → 2027, mas com comparativo de 2026 reexpresso, então na prática começa em 2026. Chamado no Questor → sim, e agora com fato concreto do manual: a rotina "Optante pelo IFRS" já existe com modelos Normal/PME/ITG — o chamado confirma quando as 5 categorias do CPC 51 entram nela. E o alerta crítico: a data de adoção no Questor é irreversível, então nada de marcar data sem preparo.
Exemplo prático: termine o slide perguntando quem ainda não abriu o chamado — e já designe o responsável ali mesmo.`,
  // 3 — Introdução
...
Exemplo prático: antes, uma empresa excluía depreciação de um ativo específico dizendo que era "não recorrente"; agora, se é operacional, está dentro do subtotal — acabou a maquiagem.`,
  // 7 — Lucro antes de financiamento e tributos
...
Atenciosamente,
[NOME] — Felcont Contabilidade, Finanças e Auditoria
[E-MAIL] · [TELEFONE]`;
