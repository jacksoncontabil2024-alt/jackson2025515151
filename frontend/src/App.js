                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="pagou_a_conta">Pagou a Conta</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                                ...
                                <div className="flex flex-wrap gap-1">
                                  ...
                                  {delivery.cancelado ? (
                                    <Button
                                      ...
                                      onClick={() => handleUpdateDelivery(delivery.id, { cancelado: false })}
                                      data-testid={`uncancel-delivery-${delivery.id}`}
                                    >
                                      Descancelar
                                    </Button>
                                  ) : (
                  ...
                  <Card className="bg-gradient-to-br from-blue-600 to-blue-700 text-white border-0 shadow-xl hover:shadow-2xl transition-all">
                    ...
                    <CardContent>
                      <div className="text-4xl font-bold mb-2">
                        R$ {(reports.pix.total + reports.cartao.total + reports.dinheiro.total + reports.pago.total + reports.vem_retirar.total + reports.marcar.total + reports.pagou_a_conta.total).toFixed(2)}
                      </div>
                      <div className="text-sm text-blue-100">
                        {reports.pix.count + reports.cartao.count + reports.dinheiro.count + reports.pago.count + reports.vem_retirar.count + reports.marcar.count + reports.pagou_a_conta.count} entregas totais
                      </div>
                    </CardContent>
                  </Card>
                </div>
